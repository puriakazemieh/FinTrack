...
## کارها
- [ ] **فاز ۰: ساخت زیرساخت لایه Common**
  - [ ] ساخت اینترفیس `AnalyticsService` و `CrashReporter`
  - [ ] ساخت کلاس امن `ProductEvent` برای ایونت‌ها
  - [ ] ساخت `NoOpAnalytics` برای پیش‌گیری از کرش سیستم
...
- [ ] **فاز ۴: تزریق ایونت‌های رشد در ViewModelها (توسط هوش مصنوعی)**
  - [ ] ثبت اولین تراکنش، بودجه، چک، بدهی، قسط
